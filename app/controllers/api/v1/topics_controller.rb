class Api::V1::TopicsController < Api::V1::BaseController
	before_filter :authenticate_user, except: [:index, :show, :destory]
	before_filter :authorize_user, except: [:index, :show, :destroy]
	...
	def destroy
		...
		if topic.destroy
			...
			render json: {error: "Topic destroyed failed", status: 400}, status: 400
		end
	end
